...
@section('content')
                        ...
                        <tr>
                            <td>
                                <div class="users-profile-cell">
                                    <span class="users-avatar">{{ $initial }}</span>
                                    <div>
                            ...
                            <td data-search="{{ $roleText }}" data-order="{{ $roleText }}">
                            ...
                            <td data-order="{{ optional($user->created_at)->timestamp }}">
    ...
    {{-- Modal Edit User --}}
    @foreach ($users as $user)
        <div class="modal fade users-modal" id="editUserModal-{{ $user->id }}" tabindex="-1"
            aria-labelledby="editUserModalLabel-{{ $user->id }}" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="users-modal-title">
                            <h5 id="editUserModalLabel-{{ $user->id }}">Edit User</h5>
                        </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="users-form-group">
                                        <label>Nomor HP</label>
                                        <input type="text" name="phone_number" class="form-control"
                                            value="{{ $user->phone_number }}" placeholder="Belum diisi">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="users-form-group">
                                        <label>Role</label>
                                        <select name="role" class="form-select" required>
                                            <option value="{{ \App\Models\User::ROLE_KADER }}"
                                                @selected($user->role === \App\Models\User::ROLE_KADER)>
                                                Kader
                                            </option>
                                            <option value="{{ \App\Models\User::ROLE_SUPER_ADMIN }}"
                                                @selected($user->role === \App\Models\User::ROLE_SUPER_ADMIN)>
                                                Super Admin
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-check users-form-check">
                                        <input class="form-check-input" type="checkbox" value="1"
                                            id="edit-is-active-{{ $user->id }}" name="is_active"
                                            @checked($user->is_active)>

                                        <label class="form-check-label" for="edit-is-active-{{ $user->id }}">
                                            User aktif
                                        </label>
                                    </div>
                                </div>
