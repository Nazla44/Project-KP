...
@section('content')
        ...
        <section class="clinics-preview-card">
            <div class="clinics-table-header">
                <div>
                    ...
                    <p>{{ $preview['filename'] ?? 'File CSV' }}</p>
                </div>

                <span class="clinic-status-pill {{ ($preview['invalid_rows'] ?? 0) > 0 ? 'is-inactive' : 'is-active' }}">
                    <span></span>
            ...
            <div class="p-3 p-md-4">
                <div class="clinic-preview-summary">
                    ...
                    <div class="clinic-preview-item">
                        <span>Import ID</span>
                        <strong>{{ $preview['import_id'] ?? '-' }}</strong>
                    </div>
                </div>
                        ...
                        <tr>
                            <td>
                                <div class="clinic-main-cell">
                                    ...
                                    <small>{{ $klinik->tipe }}</small>

                                    @if ($layananText)
                                        <small class="mt-1">{{ $layananText }}</small>
                                    @endif
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="clinic-location-cell">
                                    <strong>{{ $klinik->kota }}, {{ $klinik->provinsi }}</strong>
                                    <small>{{ $klinik->alamat }}</small>
                                    <small>{{ $klinik->latitude }}, {{ $klinik->longitude }}</small>
                                </div>
                            </td>
                            ...
                            <td data-search="{{ $statusText }}" data-order="{{ $statusText }}">
                                <span class="clinic-status-pill {{ $isActive ? 'is-active' : 'is-inactive' }}">
                                    <span></span>
                                    {{ $statusText }}
                                </span>
                            </td>
                            ...
                            <td>
                                <div class="clinics-actions">
                                    <button type="button" class="clinics-icon-button" title="Edit klinik"
                                        data-bs-toggle="modal" data-bs-target="#editKlinikModal-{{ $klinik->id }}">
                                        <i class="bi bi-pencil-square"></i>
                                    </button>

                                    <form method="POST" action="{{ route('admin.kliniks.destroy', $klinik) }}"
                ...
                <tbody>
                    @forelse ($recentImports as $import)
                        <tr>
                            ...
                            <td>
                                <span
                                    class="clinic-status-pill {{ $import->status === 'imported' ? 'is-active' : 'is-inactive' }}">
                                    <span></span>
                            ...
                            <div class="col-12">
                                <div class="clinic-form-group">
                                    ...
                                    <input type="text" id="create-nama" name="nama" class="form-control"
                                        value="{{ old('_modal') === 'create' ? old('nama') : '' }}"
                            ...
                            <div class="col-md-4">
                                <div class="clinic-form-group">
                                    ...
                                    <input type="text" id="create-tipe" name="tipe" class="form-control"
                                        value="{{ old('_modal') === 'create' ? old('tipe') : '' }}"
                            ...
                            <div class="col-md-4">
                                <div class="clinic-form-group">
                                    ...
                                    <input type="text" id="create-kota" name="kota" class="form-control"
                                        value="{{ old('_modal') === 'create' ? old('kota') : '' }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="clinic-form-group">
                                    ...
                                    <input type="text" id="create-provinsi" name="provinsi" class="form-control"
                                        value="{{ old('_modal') === 'create' ? old('provinsi') : '' }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="clinic-form-group">
                                    ...
                                    <textarea id="create-alamat" name="alamat" class="form-control" rows="2"
                                        placeholder="Masukkan alamat lengkap klinik" required>{{ old('_modal') === 'create' ? old('alamat') : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="clinic-form-group">
                                    ...
                                    <input type="text" id="create-telepon" name="telepon" class="form-control"
                                        value="{{ old('_modal') === 'create' ? old('telepon') : '' }}"
                            ...
                            <div class="col-md-4">
                                <div class="clinic-form-group">
                                    ...
                                    <input type="number" step="0.0000001" id="create-latitude" name="latitude"
                                        class="form-control"
                                        value="{{ old('_modal') === 'create' ? old('latitude') : '' }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="clinic-form-group">
                                    ...
                                    <input type="number" step="0.0000001" id="create-longitude" name="longitude"
                                        class="form-control"
                                        value="{{ old('_modal') === 'create' ? old('longitude') : '' }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="clinic-form-group">
                                    ...
                                    <input type="time" id="create-jam-buka" name="jam_buka" class="form-control"
                                        value="{{ old('_modal') === 'create' ? old('jam_buka') : '' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="clinic-form-group">
                                    ...
                                    <input type="time" id="create-jam-tutup" name="jam_tutup" class="form-control"
                                        value="{{ old('_modal') === 'create' ? old('jam_tutup') : '' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="clinic-form-group">
                                    ...
                                    <input type="text" id="create-hari-buka" name="hari_buka" class="form-control"
                                        value="{{ old('_modal') === 'create' ? old('hari_buka') : '' }}"
                            ...
                            <div class="col-md-3">
                                <div class="clinic-form-group">
                                    ...
                                    <input type="text" id="create-hari-tutup" name="hari_tutup" class="form-control"
                                        value="{{ old('_modal') === 'create' ? old('hari_tutup') : '' }}"
                            ...
                            <div class="col-md-8">
                                <div class="clinic-form-group">
                                    ...
                                    <textarea id="create-layanan" name="layanan" class="form-control" rows="2"
                                        placeholder="Pisahkan dengan koma atau baris baru">{{ old('_modal') === 'create' ? old('layanan') : '' }}</textarea>
                            ...
                            <div class="col-md-4">
                                <div class="clinic-form-group">
                                    ...
                                    <select id="create-status" name="status" class="form-select" required>
                                        <option value="aktif" @selected(old('_modal') !== 'create' || old('status', 'aktif') === 'aktif')>
                                            Aktif
                                        </option>
                                        <option value="nonaktif" @selected(old('_modal') === 'create' && old('status') === 'nonaktif')>
                                            Nonaktif
                                        </option>
                                    </select>
                                </div>
    ...
    @foreach ($kliniks as $klinik)
        ...
        <div class="modal fade clinic-modal" id="editKlinikModal-{{ $klinik->id }}" tabindex="-1"
            aria-labelledby="editKlinikModalLabel-{{ $klinik->id }}" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="clinic-modal-title">
                            <h5 id="editKlinikModalLabel-{{ $klinik->id }}">Edit Klinik</h5>
                            <p>{{ $klinik->nama }}</p>
                        </div>
                    ...
                    <form method="POST" action="{{ route('admin.kliniks.update', $klinik) }}">
                        ...
                        <input type="hidden" name="_klinik_id" value="{{ $klinik->id }}">

                        <div class="modal-body">
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="clinic-form-group">
                                        <label for="edit-nama-{{ $klinik->id }}">Nama Klinik</label>
                                        <input type="text" id="edit-nama-{{ $klinik->id }}" name="nama"
                                            class="form-control"
                                            value="{{ $isOldEditKlinik ? old('nama') : $klinik->nama }}" required>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="clinic-form-group">
                                        <label for="edit-tipe-{{ $klinik->id }}">Tipe</label>
                                        <input type="text" id="edit-tipe-{{ $klinik->id }}" name="tipe"
                                            class="form-control"
                                            value="{{ $isOldEditKlinik ? old('tipe') : $klinik->tipe }}" required>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="clinic-form-group">
                                        <label for="edit-kota-{{ $klinik->id }}">Kota</label>
                                        <input type="text" id="edit-kota-{{ $klinik->id }}" name="kota"
                                            class="form-control"
                                            value="{{ $isOldEditKlinik ? old('kota') : $klinik->kota }}" required>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="clinic-form-group">
                                        <label for="edit-provinsi-{{ $klinik->id }}">Provinsi</label>
                                        <input type="text" id="edit-provinsi-{{ $klinik->id }}" name="provinsi"
                                            class="form-control"
                                            value="{{ $isOldEditKlinik ? old('provinsi') : $klinik->provinsi }}" required>
                                    </div>
                                </div>

                                <div class="col-12">
                                    <div class="clinic-form-group">
                                        <label for="edit-alamat-{{ $klinik->id }}">Alamat</label>
                                        <textarea id="edit-alamat-{{ $klinik->id }}" name="alamat" class="form-control" rows="2" required>{{ $isOldEditKlinik ? old('alamat') : $klinik->alamat }}</textarea>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="clinic-form-group">
                                        <label for="edit-telepon-{{ $klinik->id }}">Telepon</label>
                                        <input type="text" id="edit-telepon-{{ $klinik->id }}" name="telepon"
                                            class="form-control"
                                            value="{{ $isOldEditKlinik ? old('telepon') : $klinik->telepon }}"
                                            placeholder="Opsional">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="clinic-form-group">
                                        <label for="edit-latitude-{{ $klinik->id }}">Latitude</label>
                                        <input type="number" step="0.0000001" id="edit-latitude-{{ $klinik->id }}"
                                            name="latitude" class="form-control"
                                            value="{{ $isOldEditKlinik ? old('latitude') : $klinik->latitude }}" required>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="clinic-form-group">
                                        <label for="edit-longitude-{{ $klinik->id }}">Longitude</label>
                                        <input type="number" step="0.0000001" id="edit-longitude-{{ $klinik->id }}"
                                            name="longitude" class="form-control"
                                            value="{{ $isOldEditKlinik ? old('longitude') : $klinik->longitude }}"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="clinic-form-group">
                                        <label for="edit-jam-buka-{{ $klinik->id }}">Jam Buka</label>
                                        <input type="time" id="edit-jam-buka-{{ $klinik->id }}" name="jam_buka"
                                            class="form-control"
                                            value="{{ $isOldEditKlinik ? old('jam_buka') : $klinik->jam_buka }}">
                                    </div>
                                </div>

                                <div class="col-md-3">
                                    <div class="clinic-form-group">
                                        <label for="edit-jam-tutup-{{ $klinik->id }}">Jam Tutup</label>
                                        <input type="time" id="edit-jam-tutup-{{ $klinik->id }}" name="jam_tutup"
                                            class="form-control"
                                            value="{{ $isOldEditKlinik ? old('jam_tutup') : $klinik->jam_tutup }}">
                                    </div>
                                </div>

                                <div class="col-md-3">
                                    <div class="clinic-form-group">
                                        <label for="edit-hari-buka-{{ $klinik->id }}">Hari Buka</label>
                                        <input type="text" id="edit-hari-buka-{{ $klinik->id }}" name="hari_buka"
                                            class="form-control"
                                            value="{{ $isOldEditKlinik ? old('hari_buka') : $klinik->hari_buka }}"
                                            placeholder="Senin - Jumat">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="clinic-form-group">
                                        <label for="edit-hari-tutup-{{ $klinik->id }}">Hari Tutup</label>
                                        <input type="text" id="edit-hari-tutup-{{ $klinik->id }}" name="hari_tutup"
                                            class="form-control"
                                            value="{{ $isOldEditKlinik ? old('hari_tutup') : $klinik->hari_tutup }}"
                                            placeholder="Sabtu, Minggu">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="clinic-form-group">
                                        <label for="edit-layanan-{{ $klinik->id }}">Layanan</label>
                                        <textarea id="edit-layanan-{{ $klinik->id }}" name="layanan" class="form-control" rows="2"
                                            placeholder="Pisahkan dengan koma atau baris baru">{{ $layananValue }}</textarea>
                                        <div class="clinic-form-help">
                                            Contoh: Skrining TBC, Konsultasi, Pemeriksaan Dahak
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="clinic-form-group">
                                        <label for="edit-status-{{ $klinik->id }}">Status</label>
                                        <select id="edit-status-{{ $klinik->id }}" name="status" class="form-select"
                                            required>
                                            <option value="aktif" @selected($selectedStatus === 'aktif')>
                                                Aktif
                                            </option>
                                            <option value="nonaktif" @selected($selectedStatus === 'nonaktif')>
                                                Nonaktif
                                            </option>
                                        </select>
                                    </div>
...
@push('scripts')
    <script>
        ...
        @if ($errors->any() && old('_modal') === 'import')
            new bootstrap.Modal(document.getElementById('importKlinikModal')).show();
        @endif

        @if ($errors->any() && old('_modal') === 'edit' && old('_klinik_id'))
            new bootstrap.Modal(
                document.getElementById('editKlinikModal-{{ old('_klinik_id') }}')
            ).show();
        @endif
    </script>
@endpush
