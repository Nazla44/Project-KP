        ...
        <div class="container-xl px-4 px-lg-5">
                            ...
                            <div class="fk-fields">
                                ...
                                <div class="fk-field-group">
                                    ...
                                    <input type="text" id="nama_lengkap" name="nama_lengkap"
                                        ...
                                        value="{{ old('nama_lengkap') }}" placeholder="Sesuai KTP" autocomplete="name">
                                ...
                                <div class="fk-field-group">
                                    ...
                                    <input type="text" id="nik" name="nik"
                                        class="fk-input @error('nik') is-invalid @enderror" value="{{ old('nik') }}"
                                ...
                                <div class="row g-3">
                                    <div class="col-12 col-md-8">
                                        <div class="fk-field-group">
                                            ...
                                            {{-- 
                                            INI SATU FIELD TEMPAT LAHIR.
                                            Yang dikirim ke database tetap name="tempat_lahir".
                                            Provinsi dan kabupaten/kota hanya muncul di panel pilihan.
                                        --}}
                                            <div class="fk-region-picker">
                                                <div class="fk-region-input-wrap">
                                                    <input type="text" id="tempat_lahir" name="tempat_lahir"
                                                        class="fk-input fk-region-input @error('tempat_lahir') is-invalid @enderror"
                                                        value="{{ old('tempat_lahir') }}" placeholder="Pilih tempat lahir"
                            ...
                            <div class="fk-fields">
                                ...
                                <div class="fk-field-group">
                                    ...
                                    <div class="fk-input-prefix-wrap">
                                        ...
                                        <input type="tel" id="no_hp" name="no_hp"
                                            ...
                                            value="{{ old('no_hp') }}" placeholder="81234567890" inputmode="numeric">
                                    </div>
                                ...
                                <div class="fk-field-group">
                                    ...
                                    <input type="email" id="email" name="email"
                                        class="fk-input @error('email') is-invalid @enderror" value="{{ old('email') }}"
                                ...
                                <div class="fk-field-group">
                                    ...
                                    <textarea id="alamat" name="alamat" rows="3"
                                        class="fk-input fk-textarea @error('alamat') is-invalid @enderror" placeholder="Nama jalan, nomor rumah, RT/RW">{{ old('alamat') }}</textarea>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="fk-field-group">
                                            ...
                                            <select id="provinsi" name="provinsi"
                                                class="fk-input fk-select @error('provinsi') is-invalid @enderror"
                                                data-old="{{ old('provinsi') }}" autocomplete="off">
                                                <option value="">Memuat provinsi...</option>
                                            </select>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="fk-field-group">
                                            ...
                                            <select id="kab_kota" name="kab_kota"
                                                class="fk-input fk-select @error('kab_kota') is-invalid @enderror"
                                                data-old="{{ old('kab_kota') }}" disabled autocomplete="off">
                                                <option value="">Pilih provinsi dulu</option>
                                            </select>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="fk-field-group">
                                            ...
                                            <select id="kecamatan" name="kecamatan"
                                                class="fk-input fk-select @error('kecamatan') is-invalid @enderror"
                                                data-old="{{ old('kecamatan') }}" disabled autocomplete="off">
                            ...
                            <div class="fk-fields">
                                ...
                                <div class="fk-field-group">
                                    ...
                                    <select id="pendidikan" name="pendidikan"
                                        ...
                                        <option value="" disabled {{ old('pendidikan') ? '' : 'selected' }}>
            ...
            'belum' => [
                ...
                'desc' => 'Saya ingin berkontribusi meski belum punya pengalaman TBC',
                                            ...
                                            <label
                                                class="fk-radio-list-item {{ old('pengalaman_tb') === $val ? 'selected' : '' }}">
            ...
            'akhir_pekan' => 'Akhir Pekan Saja',
                                            ...
                                            <label
                                                class="fk-radio-card {{ old('ketersediaan') === $val ? 'selected' : '' }}">
                            ...
                            <div class="fk-fields">
                                ...
                                <div class="fk-checkbox-wrap @error('setuju') is-invalid @enderror">
                                    <input type="checkbox" id="setuju" name="setuju" value="1"
                                        class="fk-checkbox" {{ old('setuju') ? 'checked' : '' }}>
                    ...
                    <div class="fk-sidebar">
                        ...
                        <div class="fk-sidebar-block mb-4">
                            ...
                            <div class="fk-benefit-list">
                                @foreach ([['icon' => 'bi-mortarboard-fill', 'text' => 'Pelatihan kader bersertifikat'], ['icon' => 'bi-currency-dollar', 'text' => 'Insentif bulanan dari program'], ['icon' => 'bi-people-fill', 'text' => 'Jejaring relawan TBC nasional'], ['icon' => 'bi-bag-heart-fill', 'text' => 'Perlengkapan kader (APD, ATK)'], ['icon' => 'bi-graph-up-arrow', 'text' => 'Pengembangan kapasitas rutin']] as $b)
