            ...
            <div class="row g-5">
                <div class="col-lg-4">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        <img src="{{ asset('assets/image/icon-stpi.png') }}" alt="STPI Logo" class="footer-logo">
                    </div>
                ...
                <div class="col-6 col-lg-2 py-5">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="{{ route('careers') }}">Karir</a></li>
                        <li><a href="{{ route('accountability') }}">Akuntabilitas</a></li>
                    </ul>
                </div>
