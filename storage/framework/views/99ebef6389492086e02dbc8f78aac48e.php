                ...
                <form action="<?php echo e(route('kader.submit')); ?>" method="POST" class="fk-form" novalidate>
                    ...
                    <?php if($errors->any()): ?>
                        <div class="fk-alert-error mb-4">
                            ...
                            Mohon periksa kembali isian Anda. Ada <strong><?php echo e($errors->count()); ?></strong> field yang perlu diperbaiki.
                        </div>
                    <?php endif; ?>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="fk-field-group">
                                        ...
                                        <input type="text"
                                               id="tempat_lahir"
                                               name="tempat_lahir"
                                               class="fk-input <?php $__errorArgs = ['tempat_lahir'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                          placeholder="Nama jalan, nomor rumah, RT/RW"><?php echo e(old('alamat')); ?></textarea>
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="fk-field-group">
                                        ...
                                        <input type="text"
                                               id="provinsi"
                                               name="provinsi"
                                               class="fk-input <?php $__errorArgs = ['provinsi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="fk-field-group">
                                        ...
                                        <input type="text"
                                               id="kab_kota"
                                               name="kab_kota"
                                               class="fk-input <?php $__errorArgs = ['kab_kota'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="fk-field-group">
                                        ...
                                        <input type="text"
                                               id="kecamatan"
                                               name="kecamatan"
                                               class="fk-input <?php $__errorArgs = ['kecamatan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    <option value="" disabled <?php echo e(old('pendidikan') ? '' : 'selected'); ?>>Pilih pendidikan terakhir</option>
                                    <?php $__currentLoopData = ['SD' => 'SD / Sederajat', 'SMP' => 'SMP / Sederajat', 'SMA' => 'SMA / SMK / Sederajat', 'D3' => 'Diploma (D1–D3)', 'S1' => 'Sarjana (S1)', 'S2' => 'Magister (S2)', 'S3' => 'Doktor (S3)']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($val); ?>" <?php echo e(old('pendidikan') === $val ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                            ...
                            <div class="fk-field-group">
                                ...
                                <div class="fk-radio-list">
                                    <?php $__currentLoopData = [
                                        ...
                                        <label class="fk-radio-list-item <?php echo e(old('pengalaman_tb') === $val ? 'selected' : ''); ?>">
                            ...
                            <div class="fk-field-group">
                                ...
                                <div class="fk-radio-group">
                                    <?php $__currentLoopData = [
                                        ...
                                        <label class="fk-radio-card <?php echo e(old('ketersediaan') === $val ? 'selected' : ''); ?>">
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Punya Aska\Kulyeah\SEMESTER 6\KP\Project-KP-kader-flow-refactored\Project-KP - Copy\resources\views/pages/daftar-kader.blade.php ENDPATH**/ ?>