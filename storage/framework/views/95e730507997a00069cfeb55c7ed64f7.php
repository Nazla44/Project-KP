        ...
        <div class="row justify-content-center text-center">
            <div class="col-12 col-lg-8">
                ...
                <div class="d-flex flex-wrap justify-content-center gap-3">
                    ...
                    <a href="<?php echo e(route('kader.form')); ?>" class="btn-primary-red">
                        Daftar Jadi Kader
                        <span class="btn-icon"><i class="bi bi-arrow-up-right"></i></span>
                    </a>
                    <a href="<?php echo e(route('klinik-terdekat')); ?>" class="pk-btn-outline-white">
...
</section><?php /**PATH D:\Punya Aska\Kulyeah\SEMESTER 6\KP\Project-KP-kader-flow-refactored\Project-KP - Copy\resources\views/sections/program-komunitas/mitra.blade.php ENDPATH**/ ?>