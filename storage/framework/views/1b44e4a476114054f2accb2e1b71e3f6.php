                        ...
                        <tr>
                            ...
                            <td>
                                <div class="articles-actions">
                                    <a href="<?php echo e(route('artikel.show', $article->slug)); ?>" class="articles-icon-button"
                                    ...
                                    <form
                                        method="POST"
                                        action="<?php echo e(route('admin.articles.destroy', $article)); ?>"
        ...
        <div class="modal fade article-modal" id="editArticleModal-<?php echo e($article->id); ?>" tabindex="-1"
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <form
                        method="POST"
                        action="<?php echo e(route('admin.articles.update', $article)); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/aureliadwiwi/Desktop/KP/STPI/Project-KP/resources/views/admin/artikel/index.blade.php ENDPATH**/ ?>