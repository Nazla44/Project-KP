<aside class="admin-sidebar" id="adminSidebar">
    ...
    <div class="admin-sidebar-scroll">
        ...
        <nav class="admin-nav">
            ...
            <a href="<?php echo e(route('admin.reports.overview')); ?>"
                class="admin-nav-link <?php echo e(request()->routeIs('admin.reports.*') ? 'active' : ''); ?>">
...
<?php /**PATH /Users/aureliadwiwi/Desktop/KP/STPI/Project-KP/resources/views/partials/admin/sidebar.blade.php ENDPATH**/ ?>